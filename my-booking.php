...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
    ...
    <input type="hidden" name="business" value="gharatsuraj1865@gmail.com">

    <!-- Transaction Command -->
    <input type="hidden" name="cmd" value="_xclick">

    <!-- Item Details -->
    <input type="hidden" name="item_name" value="<?php echo $car_name; ?>">
    <input type="hidden" name="amount" value="<?php echo $total_price; ?>">
    <input type="hidden" name="currency_code" value="USD">

    <!-- Return URLs -->
    <input type="hidden" name="return" value="http://localhost/carrental/paypal_success.php">
    <input type="hidden" name="cancel_return" value="http://localhost/carrental/paypal_cancel.php">

    <!-- Button -->
    <button type="submit" style="padding:10px 20px; background:#0070ba; color:white; border:none; border-radius:5px;">
        Pay With PayPal
    </button>
</form>
</body>
