...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
    ...
    <!-- Item details -->
    <input type="hidden" name="item_name" value="Car Rental Booking">
    <input type="hidden" name="amount" value="50"> <!-- Change this dynamically -->
    <input type="hidden" name="currency_code" value="USD">

    <!-- Success and Cancel URLs -->
    <input type="hidden" name="return" value="http://yourdomain.com/paypal_success.php">
    <input type="hidden" name="cancel_return" value="http://yourdomain.com/paypal_cancel.php">
